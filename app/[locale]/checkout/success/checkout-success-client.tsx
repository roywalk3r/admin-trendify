    ...
    <div className="container mx-auto max-w-2xl py-20">
          ...
          <div className="bg-background rounded-md p-4 border">
            <div className="flex items-center gap-3 text-sm">
              ...
              <div>
                ...
                <p className="text-muted-foreground">We&apos;ve sent order details to your email address</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="mt-8 p-4 bg-blue-50 rounded-lg border border-blue-200">
        <p className="text-sm text-blue-900">
          <strong>What&apos;s Next?</strong> Your order is being processed. You&apos;ll receive shipping updates via email. Track your order anytime from your order history.
        </p>
      </div>
    </div>
  )
