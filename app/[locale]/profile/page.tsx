                              ...
                              {orders.map((order) => (
                                  <TableRow key={order.id} className="hover:bg-muted/30 transition-colors">
                                    <TableCell className="font-medium">
                                      <Link href={`/orders/${order.orderNumber}`} className="hover:underline">#{order.orderNumber}</Link>
                                    </TableCell>
                                    ...
                                    <TableCell className="text-right font-medium space-x-2">
                                      ...
                                      <Link href={`/orders/${order.orderNumber}`} className="text-sm underline ml-2">View</Link>
                                    </TableCell>
                                  </TableRow>
                              ))}
                            </TableBody>
